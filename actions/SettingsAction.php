...
namespace Redbox\PersonalSettings\actions;
...
use Redbox\PersonalSettings\events\FormEvent;

/**
 * Class SettingsAction
 *
 * @package Redbox\PersonalSettings\actions
 */
class SettingsAction extends Action
{
    /**
     * Event is triggered before the settings will be saved.
     * Triggered with \Redbox\PersonalSettings\events\FormEvent.
     */
